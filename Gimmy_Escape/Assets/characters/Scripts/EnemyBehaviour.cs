...
public class EnemyBehaviour : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        StartCoroutine(Move());
        Turning = GameObject.Find("Enemy").GetComponent<Animation>();
        //GameObject enemy1;
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.tag == "Enemy" && x < 0.00000001f)
        {
            ...
            GameObject.Find("Enemy").GetComponent<EnemyMovement>().walkSpeed = 0;
        ...
        if (other.tag == "Enemy" && x > -0.00000001f)
        {
            ...
            Debug.Log("Enemy Collision Detected");
            GameObject.Find("Enemy").GetComponent<EnemyMovement>().walkSpeed = 0;
            //GameObject.Find("ColliderDetecter").GetComponent<Collider>().ColliderDetecter.position.x = 3;
    ...
    IEnumerator TurningTime()
    {
        ...
        GameObject.Find("Enemy").GetComponent<EnemyMovement>().walkSpeed = 2;
        Turning.Play("Walk");
